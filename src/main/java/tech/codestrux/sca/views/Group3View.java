...
public class Group3View extends VerticalLayout {
    ...
    public Group3View(Prueba prueba) {
        ...
        // Pregunta 3
        add(new H4("9. ¿Por qué es importante deshabilitar servicios o funcionalidades que no se utilizan en un servidor web?"));
        ...
        if (prueba != null) {
            radioGroupQ7.setValue(prueba.getRespuestasUsuario().get(7));
            radioGroupQ8.setValue(prueba.getRespuestasUsuario().get(8));
            radioGroupQ9.setValue(prueba.getRespuestasUsuario().get(9));
        }

        Button button = new Button("siguiente", e -> {
            if (prueba != null) {
                prueba.getRespuestasUsuario().put(7, radioGroupQ7.getValue());
                prueba.getRespuestasUsuario().put(8, radioGroupQ8.getValue());
                prueba.getRespuestasUsuario().put(9, radioGroupQ9.getValue());
            }
