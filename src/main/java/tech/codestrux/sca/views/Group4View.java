...
public class Group4View extends VerticalLayout {
    ...
    public Group4View(Prueba prueba) {
        ...
        radioGroupQ11.setItems("a) Actualizar sistemas una vez al año",
                "b) Implementar un sistema de revisión periódica para identificar amenazas y actividades sospechosas en tiempo real",
        ...
        if (prueba != null) {
            radioGroupQ10.setValue(prueba.getRespuestasUsuario().get(10));
            radioGroupQ11.setValue(prueba.getRespuestasUsuario().get(11));
            radioGroupQ12.setValue(prueba.getRespuestasUsuario().get(12));
        }

        Button button = new Button("siguiente", e -> {
            if (prueba != null) {
                prueba.getRespuestasUsuario().put(10, radioGroupQ10.getValue());
                prueba.getRespuestasUsuario().put(11, radioGroupQ11.getValue());
                prueba.getRespuestasUsuario().put(12, radioGroupQ12.getValue());
            }
