...
public class Group2View extends VerticalLayout {
    ...
    public Group2View(Prueba prueba) {
        ...
        if (prueba != null) {
            radioGroupQ4.setValue(prueba.getRespuestasUsuario().get(4));
            radioGroupQ5.setValue(prueba.getRespuestasUsuario().get(5));
            radioGroupQ6.setValue(prueba.getRespuestasUsuario().get(6));
        }

        Button button = new Button("siguiente", e -> {
            if (prueba != null) {
                prueba.getRespuestasUsuario().put(4, radioGroupQ4.getValue());
                prueba.getRespuestasUsuario().put(5, radioGroupQ5.getValue());
                prueba.getRespuestasUsuario().put(6, radioGroupQ6.getValue());
            }
