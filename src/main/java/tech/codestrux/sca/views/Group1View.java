...
public class Group1View extends VerticalLayout {
    ...
    public Group1View(Prueba prueba) {
        ...
        if (prueba != null) {
            radioGroupQ1.setValue(prueba.getRespuestasUsuario().get(1));
            radioGroupQ2.setValue(prueba.getRespuestasUsuario().get(2));
            radioGroupQ3.setValue(prueba.getRespuestasUsuario().get(3));
        }

        Button button = new Button("siguiente", e -> {
            if (prueba != null) {
                prueba.getRespuestasUsuario().put(1, radioGroupQ1.getValue());
                prueba.getRespuestasUsuario().put(2, radioGroupQ2.getValue());
                prueba.getRespuestasUsuario().put(3, radioGroupQ3.getValue());
            }
