...
public class Group5View extends VerticalLayout {
    ...
    public Group5View(Prueba prueba) {
        ...
        if (prueba != null) {
            radioGroupQ13.setValue(prueba.getRespuestasUsuario().get(13));
            radioGroupQ14.setValue(prueba.getRespuestasUsuario().get(14));
            radioGroupQ15.setValue(prueba.getRespuestasUsuario().get(15));
        }

        Button button = new Button("finalizar", e -> {
            if (prueba != null) {
                prueba.getRespuestasUsuario().put(13, radioGroupQ13.getValue());
                prueba.getRespuestasUsuario().put(14, radioGroupQ14.getValue());
                prueba.getRespuestasUsuario().put(15, radioGroupQ15.getValue());
            }
